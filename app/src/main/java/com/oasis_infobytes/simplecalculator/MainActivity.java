package com.oasis_infobytes.simplecalculator;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        for(Button b :nums){
            b.setOnClickListener(view ->{
                if(!screen.getText().toString().equals("0")){
                    ...
                    //screen1.setText(screen.getText().toString()+b.getText().toString());
                   // screen1.setVisibility(View.VISIBLE);
                }else{
       ...
       ArrayList<Button> opers = new ArrayList<>();
        ...
        equal.setOnClickListener(view ->{
            ...
            screen1.setText(screen1.getText().toString()+screen.getText().toString());
            double result;
            switch (Operation){
                case "/":
